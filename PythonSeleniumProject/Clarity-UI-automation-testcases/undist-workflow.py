...
time.sleep(3)
driver.find_element(By.XPATH, "//*[contains(@value, 'Two')]").click()
workflow = driver.find_element(By.XPATH, "//*[contains(@id, 'workflow-name')]")
workflow.clear()
workflow.send_keys("test-distortion")
time.sleep(2)
workflow.submit()
time.sleep(3)
...
driver.find_element(By.XPATH, "(//span[@class='fui-AccordionHeader__expandIcon ___7oynyr0 f1l02sjl f22iagw f122n59 f106mvju f1pp30po f1vdfbxk'])[1]").click()
time.sleep(2)
filter_folder = driver.find_element(By.XPATH, "(//input[@class='fui-Input__input r12stul0 ___1q6bera ffczdla'])")
filter_folder.clear()
filter_folder.send_keys("/cathx_data/images/output")
time.sleep(2)
dist_calib = driver.find_element(By.XPATH, "(//span[@class='flowItem_text'])[2]")
dist_calib.click()
time.sleep(2)
...
time.sleep(2)
save_image = driver.find_element(By.XPATH, "(//span[@class='flowItem_text'])[3]")
save_image.click()
time.sleep(2)
save_microservice = driver.find_element(By.XPATH, "//*[contains(@class, 'fui-DialogContent r1v5zwsm')]")
save_microservice_text = save_microservice.text

...
folder_path_1 = "//10.1.10.123/clarity/images/session_name/hd-test-7/m90/m90_Stills"
folder_path_2 = "//10.1.10.123/clarity/images/session_name/uhd-test-3/m90/m90_Stills"
folder_path_3 = "//10.1.10.123/clarity/images/session_name/full-test-3/m90/m90_Stills"

folder_path_4 = "//10.1.10.123/clarity/images/session_name/png-hd-test-7/m90/m90_Stills"
folder_path_5 = "//10.1.10.123/clarity/images/session_name/png-uhd-test-3/m90/m90_Stills"
folder_path_6 = "//10.1.10.123/clarity/images/session_name/png-full-test-3/m90/m90_Stills"

folder_path_7 = "//10.1.10.123/clarity/images/session_name/bmp-hd-test-7/m90/m90_Stills"
folder_path_8 = "//10.1.10.123/clarity/images/session_name/bmp-uhd-test-3/m90/m90_Stills"
folder_path_9 = "//10.1.10.123/clarity/images/session_name/bmp-full-test-3/m90/m90_Stills"
...
logging.basicConfig(filename='Frame-Rate-Test-full.log',  # File name to write logs to
...
if saved_text == expected_text:
    print("Advanced Image Enhancement was added to list")
    logging.info(f'Advanced Image Enhancement was added to list and saved')
else:
    print("Advanced Image Enhancement was not added")
    logging.error(f'Problem occurred while adding Advanced Image Enhancement workflow and could not be added to the list')
...
#update mask filepath
mask = driver.find_element(By.XPATH, "//*[contains(@class, 'p--relative')][3]")
mask.click()
time.sleep(2)
...
expected_text = "Saved!"
if saved_text == expected_text:
    print("Workflow was saved with updated mask filepath")
    logging.info(f'Mask filepath set to {hd_mask}')
else:
    print("Mask filepath was not updated")
    logging.error(f'Problem occurred while changing mask filepath')

#update sub-session name
save_image = driver.find_element(By.XPATH, "//*[contains(@class, 'p--relative')][7]")
save_image.click()
time.sleep(2)
...
sub_session.clear()
sub_session.send_keys("hd-test-7")
...
if saved_text == expected_text:
    ...
    logging.info(f'Sub-session set to hd-test-7')
else:
...
sub_session.send_keys("uhd-test-3")
...
if saved_text == expected_text:
    print("Workflow was saved with updated sub-session name")
    logging.info(f'Sub-session set to uhd-test-3')
else:
    print("Workflow was not saved with updated sub-session name")
    logging.error(f'Sub-session name could not be saved')
...
if saved_text == expected_text:
    print("Workflow was saved with updated mask filepath")
    logging.info(f'Mask filepath set to {uhd_mask}')
else:
    print("Mask filepath was not updated")
    logging.error(f'Problem occurred while changing mask filepath')
...
if saved_text == expected_text:
    print("Workflow was saved with updated mask filepath")
    logging.info(f'Mask filepath set to {full_mask}')
else:
    print("Mask filepath was not updated")
    logging.error(f'Problem occurred while changing mask filepath')
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("full-test-3")
...
if saved_text == expected_text:
    print("Workflow was saved with updated sub-session name")
    logging.info(f'Sub-session set to full-test-3')
else:
    print("Workflow was not saved with updated sub-session name")
    logging.error(f'Sub-session name could not be saved')
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("png-full-test-3")
...
if saved_text == expected_text:
    ...
    logging.info(f'\nImage format set to PNG\n'
                 f'Sub-session set to png-full-test-3')
else:
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("png-uhd-test-3")
...
if saved_text == expected_text:
    print("Workflow was saved with updated sub-session name")
    logging.info(f'Sub-session set to png-uhd-test-3')
else:
    print("Workflow was not saved with updated sub-session name")
    logging.error(f'Sub-session name could not be saved')
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("png-hd-test-7")
...
if saved_text == expected_text:
    print("Workflow was saved with updated sub-session name")
    logging.info(f'Sub-session set to png-hd-test-7')
else:
    print("Workflow was not saved with updated sub-session name")
    logging.error(f'Sub-session name could not be saved')
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("bmp-hd-test-7")
...
if saved_text == expected_text:
    print("Workflow was saved with updated sub-session name")
    logging.info(f'Sub-session set to bmp-hd-test-7')
else:
    print("Workflow was not saved with updated sub-session name")
    logging.error(f'Sub-session name could not be saved')
...
if saved_text == expected_text:
    ...
    logging.info(f'\nImage format set to Windows Bitmap\n'
                 f'Sub-session set to bmp-hd-test-7')
else:
    print("Workflow was not saved with updated image format and sub-session name")
    logging.error(f'Image format and sub-session name could not be saved')
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("bmp-uhd-test-3")
...
if saved_text == expected_text:
    print("Workflow was saved with updated sub-session name")
    logging.info(f'Sub-session set to bmp-uhd-test-3')
else:
    print("Workflow was not saved with updated sub-session name")
    logging.error(f'Sub-session name could not be saved')
...
sub_session.send_keys(Keys.CONTROL + "a")
sub_session.send_keys(Keys.DELETE)
sub_session.send_keys("bmp-full-test-3")
